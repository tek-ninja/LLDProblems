package FoodDeliveryServiceDemo.strategies;
...
import FoodDeliveryService.strategies.*;
...
public class FoodDeliveryServiceDemo {
    public static void main(String[] args) {
        ...
        // 3. Register entities
        Customer alice = service.registerCustomers("Alice", "123-4567-890", aliceAddress);
        Restaurant pizzaPalace = service.registerRestaurants("Pizza Palace", pizzaAddress);
        Restaurant burgerBarn = service.registerRestaurants("Burger Barn", burgerAddress);
        Restaurant tacoTown = service.registerRestaurants("Taco Town", tacoAddress);
        service.registerDeliveryAgents("Bob", "321-4567-880", new Address("1 B", "Springfield", "12345", 40.71, -74.00));
